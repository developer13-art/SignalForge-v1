...
const ConsistencyDiscipline = function ConsistencyDiscipline() {
  ...
  const fetchData = useCallback(async () => {
    setLoading(true);
    try {
      const response = await fetch('/api/trader-intelligence/consistency', {
        credentials: 'include',
      });
    ...
    <Container size="lg" className="py-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <Text color="muted" className="text-xs">
              How consistently you follow your strategy
            </Text>
          </div>
        </div>
      ...
      <div className="mt-6 grid grid-cols-2 gap-4 lg:grid-cols-4">
        ...
        <StatCard
          ...
          value={data?.planAdherence !== undefined ? `${data.planAdherence}%` : '—'}
          icon={Activity}
          variant="info"
          loading={loading}
        />
...
export default ConsistencyDiscipline;