...
const WhiteLabelRevenue = function WhiteLabelRevenue() {
  ...
  const fetchData = useCallback(async () => {
    setLoading(true);
    try {
      const response = await fetch('/api/white-label/revenue', { credentials: 'include' });
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <Text color="muted" className="text-xs">
              Track revenue generated through your branded platform
            </Text>
          </div>
        </div>
