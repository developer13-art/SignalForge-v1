...
const BrowseTraders = function BrowseTraders() {
  ...
  const fetchTraders = useCallback(async () => {
    ...
    try {
      ...
      const response = await fetch(`/api/marketplace/traders?${params.toString()}`, {
        credentials: 'include',
      });
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <Text color="muted" className="text-xs">
              Discover skilled manual traders and copy their strategies
            </Text>
          </div>
        </div>
        ...
        <DataGrid
          ...
          emptyState={
            <EmptyState
              ...
              description={search ? 'Try a different search term.' : 'No traders are available.'}
            />
          }
        />
      </div>
