...
const ProviderPerformance = forwardRef(function ProviderPerformance(
  {
    metrics = {},
    sparklineData,
    period = '30d',
    ...
    <Card ref={ref} padding="lg" className={className} testId={testId} {...rest}>
      ...
      <dl className="grid grid-cols-2 gap-4 sm:grid-cols-3">
        {items.map((item) => {
          ...
          return (
            <div key={item.key}>
              <div className={['inline-flex h-8 w-8 items-center justify-center rounded-md', item.iconBg].filter(Boolean).join(' ')}>
