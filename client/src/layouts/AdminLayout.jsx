 ...
 * Admin Layout
 *
 * Administrative console shell with distinct branding (Admin Control
 * Center) and grouped sidebar sections. Fully responsive.
 *
 * @module client/src/layouts/AdminLayout
 */
...
export default function AdminLayout() {
  ...
  return (
    <div className="min-h-screen bg-background text-text-primary">
      <Sidebar variant="admin" collapsed={collapsed} />
      ...
      <MobileNav open={mobileOpen} variant="admin" onClose={() => dispatch(setMobileNavOpen(false))} />
    </div>
  );
}