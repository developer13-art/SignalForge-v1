 ...
 * Support Layout
 *
 * Support console shell. Sidebar focuses on tickets, knowledge base,
 * and the help center.
 *
 * @module client/src/layouts/SupportLayout
 */
...
export default function SupportLayout() {
  ...
  return (
    <div className="min-h-screen bg-background text-text-primary">
      <Sidebar variant="support" collapsed={collapsed} />
      ...
      <MobileNav open={mobileOpen} variant="support" onClose={() => dispatch(setMobileNavOpen(false))} />
    </div>
  );
}