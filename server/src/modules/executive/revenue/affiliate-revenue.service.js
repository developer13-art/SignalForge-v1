 ...
 *
 * Aggregates affiliate-related revenue metrics. For internal
 * reporting, this represents the platform's net affiliate cost and
 * gross affiliate-driven revenue.
 *
 * @module server/modules/executive/revenue/affiliate-revenue.service
 */
...
export const affiliateRevenueService = {
  getRevenue,
};